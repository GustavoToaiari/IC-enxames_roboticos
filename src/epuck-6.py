...
# ======================
# Robô diferencial (e-puck)
# ======================

class DifferentialDriveRobot:
    def __init__(self, sim: SimInterface, params: Robo_Parametros,
                 robot_path='/ePuck/base',
                 left_motor_path='/ePuck/leftJoint',
                 right_motor_path='/ePuck/rightJoint'):
        self.sim = sim
        self.p = params
...
class MultiRobotNavigator:
    ...
    def plot_results(self):
        ...
        ax.set_xlabel('x [m]')
        ax.set_ylabel('y [m]')
        ax.set_title('Trajetórias dos ePucks com repulsão mútua e sub-goals')
        ax.legend()
        plt.show()
